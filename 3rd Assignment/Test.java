...
public class Test{
	public static void main(String args[]) {
		...
		System.out.println("Enter your choice:\n Press 1 to get details of magazine \n Press 2 to get details of the brochure");
		int ch = sc.nextInt();
		switch(ch){
		case 1: System.out.println("Enter title of the magazine: ");
		...
		Newspaper m = new Magazine(mtitle,ISBN,editor);
		m.news();
		break;
		case 2:System.out.println("Enter title of the brochure: ");
		...
		b.news();
		break;
		default: System.out.println("Wring Entry");
		}
		sc.close();
	}
}